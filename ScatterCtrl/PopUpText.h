...
public:
	PopUpInfo& SetFont(Upp::Font font)                 { StaticText::SetFont(font); 	 return *this; }
	PopUpInfo& SetInk(Color col)                       { StaticText::SetInk(col); 		 return *this; }
	PopUpInfo& SetAlign(int align)                     { StaticText::SetAlign(align); 	 return *this; }
	PopUpInfo& SetImage(const Image& img, int spc = 0) { StaticText::SetImage(img, spc); return *this; }
	PopUpInfo& SetText(const char *text)               { StaticText::SetText(text); 	 return *this; }
